...
@Route(value = "supply", layout = HomeLayout.class)
@PageTitle("Supply Chain")
public class Supply extends VerticalLayout {
    ...
    private HorizontalLayout createHeader() {
        H1 title = new H1("Supply Chain Management");
    ...
    private VerticalLayout createTabbedContent() {
        ...
        viewTabs = new Tabs(inventoryTab, ordersTab, vendorsTab);
        ...
        viewTabs.addSelectedChangeListener(event -> {
            ...
            if (event.getSelectedTab().equals(inventoryTab)) {
                ...
                contentContainer.add(ordersContent);
            } else {
    ...
    private Div createInventoryContent() {
        ...
        inventoryGrid.addColumn(new ComponentRenderer<>(item -> {
            ...
            deleteButton.addThemeVariants(com.vaadin.flow.component.button.ButtonVariant.LUMO_SMALL, com.vaadin.flow.component.button.ButtonVariant.LUMO_TERTIARY, com.vaadin.flow.component.button.ButtonVariant.LUMO_ERROR);
    ...
    private Div createOrdersContent() {
        ...
        ordersGrid.addColumn(new ComponentRenderer<>(order -> {
            ...
            updateButton.addThemeVariants(com.vaadin.flow.component.button.ButtonVariant.LUMO_SMALL, com.vaadin.flow.component.button.ButtonVariant.LUMO_TERTIARY, com.vaadin.flow.component.button.ButtonVariant.LUMO_SUCCESS);
    ...
    private Div createVendorsContent() {
        ...
        vendorsGrid.addColumn(new ComponentRenderer<>(vendor -> {
            ...
            orderButton.addThemeVariants(com.vaadin.flow.component.button.ButtonVariant.LUMO_SMALL, com.vaadin.flow.component.button.ButtonVariant.LUMO_TERTIARY, com.vaadin.flow.component.button.ButtonVariant.LUMO_SUCCESS);
